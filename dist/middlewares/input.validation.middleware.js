...
//query check
exports.dateValidation = (0, express_validator_1.query)('date').optional().isString().matches(/^(\d{4}-\d{2}-\d{2})(,\d{4}-\d{2}-\d{2})?$/);
...
exports.titleValidation = (0, express_validator_1.body)('title').isString().isLength({ max: 100 });
exports.daysValidation = (0, express_validator_1.body)('days').isArray().custom(exports.checkArrayForNumbers);
exports.firstDateValidation = (0, express_validator_1.body)('firstDate').isString().matches(/^\d{4}-\d{2}-\d{2}$/);
exports.lastDateValidation = (0, express_validator_1.body)('lastDate').optional().isString().matches(/^\d{4}-\d{2}-\d{2}$/);
